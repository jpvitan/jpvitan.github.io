            ...
            <div class="container-fluid px-4 py-4">
                <div class="row justify-content-center">
                    <div class="content-sm col text-center" data-aos="fade-up">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-auto">
                                <a class="button-pill button-pill-blue btn shadow-lg px-4 py-2 mt-4" href="mailto:jpvitanx@gmail.com">Let's Talk</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid px-3 px-md-4 py-3">
                <div class="row justify-content-center">
                    <div class="content-lg col">
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="background-image background-image-abstract card-basic card shadow-lg border-0 px-5 py-5">
                            ...
                            <div class="col-md mt-3 mt-md-0">
                                <div class="background-color background-color-seashell card-basic card shadow-lg border-0 px-5 pt-5">
                                    ...
                                    <p>A satellite tracking tool that uses the Simplified General Perturbations-4 (SGP4) model to track artificial satellites in real time with high-fidelity orbital modeling.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md mt-3 mt-md-0">
                                <div class="background-color background-color-seashell card-basic card shadow-lg border-0 px-5 py-5">
                                    ...
                                    <p>A highly customizable real-time and progressive web application that tracks and monitors the latest earthquake recorded by the United States Geological Survey within the world.</p>
